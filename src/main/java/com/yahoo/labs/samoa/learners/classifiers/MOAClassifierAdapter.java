...
public class MOAClassifierAdapter implements LocalClassifierAdapter, Configurable {
    ...
    public ClassOption learnerOption = new ClassOption("learner", 'l',
            "Classifier to train.", moa.classifiers.Classifier.class, NaiveBayes.class.getName());
    /**
     * The learner.
     */
    protected moa.classifiers.Classifier learner;
    ...
    public MOAClassifierAdapter create() {
        MOAClassifierAdapter l = new MOAClassifierAdapter(this.dataset, this.learnerOption);
        if (dataset == null) {
    ...
    public void trainOnInstance(Instance inst) {
        if (this.isInit == false) {
            this.isInit = true;
            this.learner = ((moa.classifiers.Classifier) this.learnerOption.getValue()).copy();
